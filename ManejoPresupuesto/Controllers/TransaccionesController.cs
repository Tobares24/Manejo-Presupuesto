...
namespace ManejoPresupuesto.Controllers
{
    ...
    public class TransaccionesController : Controller
    {
        ...
        public IServicioReportes servicioReportes { get; }
        ...
        public async Task<IActionResult> Semanal(int mes, int año)
        {
            ...
            IEnumerable<ResultadoObtenerPorSemana>
                transaccionesPorSemana = await servicioReportes.ObtenerReporteSemanal(usuarioId, mes, año, ViewBag);
        ...
        public async Task<IActionResult> Mensual(int año)
        {
            ...
            transaccionesAgrupadas.OrderByDescending(x => x.Mes).ToList();
        ...
        public async Task<JsonResult> ObtenerTransaccionesCalendario(DateTime start, DateTime end)
        {
            ...
            var eventosClendario = transacciones.Select(transaccion => new EventoCalendario()
            {

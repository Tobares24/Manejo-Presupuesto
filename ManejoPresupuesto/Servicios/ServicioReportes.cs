...
namespace ManejoPresupuesto.Servicios
{
    public interface IServicioReportes
    {
        ...
        Task<ReporteTransaccionesDetalladas> ObtenerTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag);
    }
    public class ServicioReportes : IServicioReportes
    {
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GenerarFechaInicioYFin(int mes, int año)
        {
            ...
            fechaFin = fechaInicio.AddMonths(1).AddDays(-1); // último día del mismo mes de fecha inicio
